...
import { numberRush } from './games/number-rush'
import { colorSpin } from './games/color-spin'
import { stackTower } from './games/stack-tower'

// 새 게임 추가 시 여기 배열에 등록하면 메인 메뉴 + 라우팅에 자동 반영됨.
export const ARCADE_GAMES: MiniGame<any>[] = [tapTiming, dodge, reaction, numberRush, colorSpin, stackTower]
