...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: '/api/og?title=Portfolio&sub=풀스택+개발자+okuma&category=dev', width: 1200, height: 630, alt: `${SITE_NAME} Portfolio` }],
    },
    twitter: {
      card: 'summary_large_image',
      title: `Portfolio — ${SITE_AUTHOR}`,
      description: `${SITE_AUTHOR}의 프론트엔드·풀스택 포트폴리오`,
      images: ['/api/og?title=Portfolio&sub=풀스택+개발자+okuma&category=dev'],
    },
  }
}
